  ...
  const handlePrimarySaveScorecard = async () => {
    ...
    try {
      ...
      for (const department of departments) {
        ...
        if (!response.ok) {
          throw new Error(
            `Failed to save primary learning scorecard for department ${department.id}`
          );
        }
      ...
      toast.success("Primary learning scorecard saved successfully");
      handleCloseModal();
    } catch (error) {
      console.error("Error saving primary learning scorecard:", error);
      toast.error("Error saving primary learning scorecard");
    }
  };
      ...
      {primaryModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center">
          ...
          <div className="bg-white p-8 rounded-lg z-10 h-[50rem] w-[96rem]">
            <div className="flex flex-row">
              <h2 className="text-2xl mb-3 font-semibold">Learning</h2>
              <button
            ...
            {!primaryEditMode && (
              <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded-lg mb-8">
                ...
                all departments in learning aspect.
              </div>
            )}
