...
const ReportInternalView = () => {
  ...
  useEffect(() => {
    const getFirstReports = async (department_id: number) => {
      ...
      try {
        ...
        setInternalReportsFirst(firstSemesterReports);
      } catch (error) {
    ...
    const getSecondReports = async (department_id: number) => {
      try {
        ...
        setInternalReportsSecond(secondSemesterReports);
      } catch (error) {
        console.error("Error fetching internal reports:", error);
      }
    };
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="break-words shadow-[0rem_0.3rem_0.3rem_0rem_rgba(0,0,0,0.25)] border border-gray-300 bg-[#FFFFFF] relative mr-5 flex flex-col pt-4 pr-5 pl-5 w-[98%] h-auto mb-5 rounded-lg pb-5">
