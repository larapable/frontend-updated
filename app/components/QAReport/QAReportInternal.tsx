...
interface ReportInternal {
  ...
  type QAReportInternalProps = {
    selectedDepartmentId: number;
    selectedYear: string;
  };

  export default function QAInternal({selectedDepartmentId,selectedYear }: QAReportInternalProps) {
    ...
    //Report
  const [internalReports, setInternalReports] = useState<ReportInternal[]>(
    []
  );
