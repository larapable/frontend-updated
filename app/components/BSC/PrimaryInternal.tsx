...
interface PrimaryInternalProps {
  selectedYear: string; 
}

const PrimaryInternal: React.FC<PrimaryInternalProps> = ({ selectedYear }) => {
...
>>>>>>> 1333e1eb49a1885902719b9a5a82afa115043793
  ...
  const handlePrimaryUpdateScorecard = async () => {
    ...
    try {
      const response = await fetch(
<<<<<<< HEAD
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/bsc/primaryInternalBsc/update/${primaryEditId}`,
=======
...
export default PrimaryInternal;